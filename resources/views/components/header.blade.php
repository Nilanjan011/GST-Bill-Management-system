    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-user">
                ...
                @else
                <li><a href="regis"><i class="fa fa-user fa-fw"></i>Registration</a>
                </li>
                <li class="divider"></li>
                <li><a href="userlogin"><i class="fa fa-sign-out fa-fw"></i> Login</a>
                </li>
                @endif
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="/customer/list"><i class="fa fa-table fa-fw"></i>Show Distributors</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>                
